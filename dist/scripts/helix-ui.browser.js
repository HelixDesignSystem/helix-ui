...
function _getCoords(position, offsetElement, referenceElement, config) {
    ...
    var _offsetFunctions$posi = offsetFunctions[position](offRect, refRect, config);

    var _offsetFunctions$posi2 = slicedToArray(_offsetFunctions$posi, 2);

    coords.x = _offsetFunctions$posi2[0];
    coords.y = _offsetFunctions$posi2[1];
...
var HXCheckboxElement = function (_HXElement) {
    ...
    function HXCheckboxElement() {
        ...
        return possibleConstructorReturn(this, (HXCheckboxElement.__proto__ || Object.getPrototypeOf(HXCheckboxElement)).call(this, tagName, template));
    }
...
var HXDisclosureElement = function (_HXElement) {
    ...
    function HXDisclosureElement() {
        ...
        var _this = possibleConstructorReturn(this, (HXDisclosureElement.__proto__ || Object.getPrototypeOf(HXDisclosureElement)).call(this));

        _this._onTargetOpen = _this._onTargetOpen.bind(_this);
        _this._onTargetClose = _this._onTargetClose.bind(_this);
        return _this;
    }
...
var HXMenuElement = function (_HXElement) {
    ...
    createClass(HXMenuElement, null, [{
        key: 'is',
        get: function get$$1() {
            return 'hx-menu';
        }
    ...
    function HXMenuElement() {
        ...
        var _this = possibleConstructorReturn(this, (HXMenuElement.__proto__ || Object.getPrototypeOf(HXMenuElement)).call(this));
...
var _billing = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><path d='M15.2 14H.8c-.44 0-.8-.36-.8-.8V2.8c0-.44.36-.8.8-.8h14.4c.44 0 .8.36.8.8v10.4c0 .44-.36.8-.8.8zM1.6 10.8h1.6v.8h1.6v-.84a2.007 2.007 0 0 0 1.507-2.576C6.052 7.337 5.213 6.8 4.329 6.8h-.695a.397.397 0 0 1-.394-.4c0-.22.176-.4.394-.4H6.4V4.4H4.8v-.8H3.2v.84A1.997 1.997 0 0 0 1.62 6.4c0 1.103.885 2 1.975 2h.803c.218 0 .395.18.395.4 0 .22-.177.4-.395.4H1.6v1.6zM9 11h5v-1H9v1zm0-3h5V7H9v1zm0-3h5V4H9v1z'/></svg>";
...
var _server = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><path d='M15.5 10.727c.276 0 .5.246.5.546v2.182c0 .3-.224.545-.5.545H.5c-.275 0-.5-.246-.5-.545v-2.182c0-.3.225-.546.5-.546h15zm0-4.363c.276 0 .5.245.5.546v2.18c0 .3-.224.547-.5.547H.5c-.275 0-.5-.246-.5-.546V6.91c0-.301.225-.546.5-.546h15zM15.5 2c.276 0 .5.246.5.546v2.182c0 .3-.224.545-.5.545H.5c-.275 0-.5-.245-.5-.545V2.546C0 2.246.225 2 .5 2h15zM13.393 13.23c.399-.009.737-.364.735-.773-.002-.426-.37-.783-.785-.762a.776.776 0 0 0-.715.792c.016.41.369.752.765.743zm0-4.397c.399-.01.737-.364.735-.773-.002-.426-.37-.783-.785-.762a.776.776 0 0 0-.715.792c.016.41.369.752.765.743zm0-4.398c.399-.01.737-.364.735-.773-.002-.426-.37-.783-.785-.762a.776.776 0 0 0-.715.792c.016.41.369.752.765.743zm-11.26 8.473h8.534v-1.09H2.134v1.09zm0-4.363h8.534V7.455H2.134v1.09zm0-4.364h8.534V3.09H2.134v1.09z'/></svg>";
...
var _ticketing = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><path d='M15 2c.55 0 1 .45 1 1v10c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h14zM8.657 5.491a1 1 0 1 0-1.742-.982L4.813 8.241 3.768 6.977a1 1 0 0 0-1.541 1.275L4.2 10.638a1.004 1.004 0 0 0 .86.358.997.997 0 0 0 .782-.505l2.815-5zM10 11h4v-1h-4v1zm0-3h4V7h-4v1zm0-3h4V4h-4v1z'/></svg>";
...
var HXIconElement = function (_HXElement) {
    ...
    createClass(HXIconElement, null, [{
        key: 'is',
        get: function get$$1() {
            return 'hx-icon';
        }
    ...
    function HXIconElement(type) {
        classCallCheck(this, HXIconElement);

        var _this = possibleConstructorReturn(this, (HXIconElement.__proto__ || Object.getPrototypeOf(HXIconElement)).call(this));
...
var HXPopoverElement = function (_HXElement) {
    ...
    function HXPopoverElement() {
        ...
        var _this = possibleConstructorReturn(this, (HXPopoverElement.__proto__ || Object.getPrototypeOf(HXPopoverElement)).call(this, tagName$1, template$1));

        _this._toggle = _this._toggle.bind(_this);
        _this._setPosition = _this._setPosition.bind(_this);
        _this._closeOnBackdropClick = _this._closeOnBackdropClick.bind(_this);
        return _this;
    }
...
var HXTabsetElement = function (_HXElement) {
    ...
    createClass(HXTabsetElement, null, [{
        key: 'is',
        get: function get$$1() {
            return 'hx-tabset';
        }
    ...
    function HXTabsetElement() {
        ...
        var _this = possibleConstructorReturn(this, (HXTabsetElement.__proto__ || Object.getPrototypeOf(HXTabsetElement)).call(this));

        _this.$tablist = _this.querySelector('hx-tablist');
    ...
    createClass(HXTabsetElement, [{
        ...
        value: function _setupIds() {
            ...
            this.tabs.forEach(function (tab, idx) {
                ...
                var tabId = 'hxTab-' + _this4.$generateId();
                var tabpanelId = 'hxTabPanel-' + _this4.$generateId();
...
var HXTooltipElement = function (_HXElement) {
    ...
    function HXTooltipElement() {
        ...
        var _this = possibleConstructorReturn(this, (HXTooltipElement.__proto__ || Object.getPrototypeOf(HXTooltipElement)).call(this, tagName$2, template$2));

        _this._show = _this._show.bind(_this);
        _this._hide = _this._hide.bind(_this);
        _this._toggle = _this._toggle.bind(_this);
        _this._setPosition = _this._setPosition.bind(_this);
        _this._closeOnBackgroundClick = _this._closeOnBackgroundClick.bind(_this);
        return _this;
    }
    ...
    createClass(HXTooltipElement, [{
        ...
        key: '_closeOnBackgroundClick',
        value: function _closeOnBackgroundClick(event) {
        ...
        key: '_destoryAllHandlers',
        value: function _destoryAllHandlers() {
            window.removeEventListener('resize', debounce_1(this._setPosition, 100));
