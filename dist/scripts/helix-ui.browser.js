(function (global, factory) {
     ...
     * @since 0.16.0
     */
    var HXFormControlElement = function (_HXElement) {
        inherits(HXFormControlElement, _HXElement);

        /** @override */
        function HXFormControlElement() {
            classCallCheck(this, HXFormControlElement);

            var _this = possibleConstructorReturn(this, (HXFormControlElement.__proto__ || Object.getPrototypeOf(HXFormControlElement)).call(this));

            _this._onCtrlBlur = _this._onCtrlBlur.bind(_this);
            _this._onCtrlChange = _this._onCtrlChange.bind(_this);
            return _this;
        }
        ...
        createClass(HXFormControlElement, [{
            key: 'connectedCallback',
            value: function connectedCallback() {
                get(HXFormControlElement.prototype.__proto__ || Object.getPrototypeOf(HXFormControlElement.prototype), 'connectedCallback', this).call(this);
            ...
            key: 'disconnectedCallback',
            value: function disconnectedCallback() {
                get(HXFormControlElement.prototype.__proto__ || Object.getPrototypeOf(HXFormControlElement.prototype), 'disconnectedCallback', this).call(this);
     ...
     * @since 0.16.0
     */
    var HXCheckboxControlElement = function (_HXFormControlElement) {
        inherits(HXCheckboxControlElement, _HXFormControlElement);

        function HXCheckboxControlElement() {
            classCallCheck(this, HXCheckboxControlElement);
            return possibleConstructorReturn(this, (HXCheckboxControlElement.__proto__ || Object.getPrototypeOf(HXCheckboxControlElement)).apply(this, arguments));
        }

        createClass(HXCheckboxControlElement, [{
            key: 'controlElement',
     ...
     * @hideconstructor
     */
    var HXDrawerElement = function (_HXElement) {
        inherits(HXDrawerElement, _HXElement);

        function HXDrawerElement() {
            classCallCheck(this, HXDrawerElement);
            return possibleConstructorReturn(this, (HXDrawerElement.__proto__ || Object.getPrototypeOf(HXDrawerElement)).apply(this, arguments));
        }

        createClass(HXDrawerElement, [{
            key: '$onCreate',
     ...
     * @hideconstructor
     */
    var HXFileControlElement = function (_HXFormControlElement) {
        inherits(HXFileControlElement, _HXFormControlElement);

        function HXFileControlElement() {
            classCallCheck(this, HXFileControlElement);
            return possibleConstructorReturn(this, (HXFileControlElement.__proto__ || Object.getPrototypeOf(HXFileControlElement)).apply(this, arguments));
        }

        createClass(HXFileControlElement, [{
            key: 'controlElement',
    ...
    var shadowStyles$b = "*,\n*::before,\n*::after {\n  box-sizing: border-box;\n  color: inherit;\n  font: inherit;\n  letter-spacing: inherit;\n}\n#hxBackdrop {\n  align-items: center;\n  background-color: var(--hxBackdrop-backgroundColor, rgba(0, 0, 0, 0.6));\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  justify-content: center;\n  padding: 1.25rem;\n  width: 100%;\n}\n#hxModal {\n  background-color: var(--hxBackgroundColor, #ffffff);\n  box-shadow: var(--hxBoxShadow, 0px 7px 9px 0 rgba(0, 0, 0, 0.3));\n  display: flex;\n  min-height: 3.5rem;\n  min-width: 25rem;\n  position: relative;\n}\n@supports (--modern: true) {\n  #hxModal {\n    min-height: 12.5rem;\n  }\n}\n#hxContent {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  width: 100%;\n}\n#hxClose {\n  background-color: transparent;\n  border: 0;\n  color: inherit;\n  cursor: pointer;\n  display: inline-block;\n  font: inherit;\n  font-weight: 500;\n  line-height: 1;\n  margin: 0;\n  padding: 0;\n  color: var(--hxClose-color, #757575);\n  height: 1rem;\n  position: absolute;\n  right: 1.25rem;\n  top: 1.25rem;\n}\n:host(.hxSm) #hxModal {\n  max-width: 30rem;\n  width: 40%;\n}\n:host #hxModal {\n  max-width: 50rem;\n  width: 60%;\n}\n:host(.hxLg) #hxModal {\n  max-width: 70rem;\n  width: 80%;\n}\n";
    ...
    var shadowStyles$c = "*,\n*::before,\n*::after {\n  box-sizing: border-box;\n  color: inherit;\n  font: inherit;\n  letter-spacing: inherit;\n}\n:host #hxPill {\n  display: flex;\n  height: 100%;\n  padding: 0 1rem;\n  white-space: nowrap;\n  width: 100%;\n}\n:host #hxDismiss {\n  background-color: transparent;\n  border: 0;\n  color: inherit;\n  cursor: pointer;\n  display: inline-block;\n  font: inherit;\n  font-weight: 500;\n  line-height: 1;\n  margin: 0;\n  padding: 0;\n  align-items: center;\n  color: var(--hxDismiss-color, #9e9e9e);\n  display: inline-flex;\n  height: 1.5em;\n  justify-content: center;\n  margin: 0 -0.5rem 0 0;\n  width: 1.5em;\n}\n:host #hxDismiss > span {\n  font-size: 0.75em;\n}\n:host #hxDismiss:hover {\n  color: var(--hxDismiss-color--hover, #000000);\n}\n:host([persist]) #hxDismiss {\n  display: none;\n}\n";
     ...
     * @since 0.16.0
     */
    var HXRadioControlElement = function (_HXFormControlElement) {
        inherits(HXRadioControlElement, _HXFormControlElement);

        function HXRadioControlElement() {
            classCallCheck(this, HXRadioControlElement);
            return possibleConstructorReturn(this, (HXRadioControlElement.__proto__ || Object.getPrototypeOf(HXRadioControlElement)).apply(this, arguments));
        }

        createClass(HXRadioControlElement, [{
            key: 'controlElement',
     ...
     * @hideconstructor
     */
    var HXRadioElement = function (_HXElement) {
        inherits(HXRadioElement, _HXElement);

        function HXRadioElement() {
            classCallCheck(this, HXRadioElement);
            return possibleConstructorReturn(this, (HXRadioElement.__proto__ || Object.getPrototypeOf(HXRadioElement)).apply(this, arguments));
        }

        createClass(HXRadioElement, null, [{
            key: 'is',
     ...
     * @since 0.16.0
     */
    var HXSelectControlElement = function (_HXFormControlElement) {
        inherits(HXSelectControlElement, _HXFormControlElement);

        function HXSelectControlElement() {
            classCallCheck(this, HXSelectControlElement);
            return possibleConstructorReturn(this, (HXSelectControlElement.__proto__ || Object.getPrototypeOf(HXSelectControlElement)).apply(this, arguments));
        }

        createClass(HXSelectControlElement, [{
            key: 'controlElement',
    ...
    var shadowStyles$h = "#hxSelect {\n  display: none;\n}\n@supports (display: grid) {\n  /*\n      auto                        2.5rem\n    +---------------------------+---------+\n    | . (\"window\")              | trigger | auto\n    +---------------------------+---------+\n  */\n  #hxSelect {\n    box-sizing: border-box;\n    display: grid;\n    grid-template-areas: '. trigger';\n    grid-template-columns: auto 2.5rem;\n    height: 100%;\n    width: 100%;\n  }\n  #hxTrigger {\n    align-items: center;\n    background-color: var(--hxTrigger-backgroundColor, #ffffff);\n    box-sizing: border-box;\n    color: inherit;\n    display: flex;\n    grid-area: trigger;\n    height: 100%;\n    justify-content: center;\n  }\n}\n";
     ...
     * @since 0.16.0
     */
    var HXSelectElement = function (_HXElement) {
        inherits(HXSelectElement, _HXElement);

        function HXSelectElement() {
            classCallCheck(this, HXSelectElement);
            return possibleConstructorReturn(this, (HXSelectElement.__proto__ || Object.getPrototypeOf(HXSelectElement)).apply(this, arguments));
        }

        createClass(HXSelectElement, null, [{
            key: 'is',
    ...
    var HXTabsetElement = function (_HXElement) {
        ...
        createClass(HXTabsetElement, [{
            ...
            */
            ...
            key: 'tabpanels',
            get: function get$$1() {
                var _selector = '#' + this.id + ' > hx-tabcontent > hx-tabpanel';
            ...
            key: 'tabs',
            get: function get$$1() {
                var _selector = '#' + this.id + ' > hx-tablist > hx-tab';
                return Array.from(this.querySelectorAll(_selector));
            }
        }, {
            key: '_tablist',
     ...
     * @since 0.16.0
     */
    var HXTextControlElement = function (_HXFormControlElement) {
        inherits(HXTextControlElement, _HXFormControlElement);

        function HXTextControlElement() {
            classCallCheck(this, HXTextControlElement);
            return possibleConstructorReturn(this, (HXTextControlElement.__proto__ || Object.getPrototypeOf(HXTextControlElement)).apply(this, arguments));
        }

        createClass(HXTextControlElement, [{
            key: 'controlElement',
     ...
     * @since 0.16.0
     */
    var HXTextareaControlElement = function (_HXFormControlElement) {
        inherits(HXTextareaControlElement, _HXFormControlElement);

        function HXTextareaControlElement() {
            classCallCheck(this, HXTextareaControlElement);
            return possibleConstructorReturn(this, (HXTextareaControlElement.__proto__ || Object.getPrototypeOf(HXTextareaControlElement)).apply(this, arguments));
        }

        createClass(HXTextareaControlElement, [{
            key: 'controlElement',
    ...
    var shadowStyles$i = "*,\n*::before,\n*::after {\n  box-sizing: border-box;\n  color: inherit;\n  font: inherit;\n  letter-spacing: inherit;\n}\n#hxCta {\n  background-color: transparent;border: 0;color: inherit;cursor: pointer;display: inline-block;font: inherit;font-weight: 500;line-height: 1;margin: 0;padding: 0;border-radius: 2px;display: inline-flex;justify-content: center;border: 1px solid #0c7c84;color: #0c7c84;font-size: 0.875rem;padding: 8px 12px;\n}\n#hxCta {\n  background-color: transparent;border: none;color: #0c7c84;padding-left: 0;padding-right: 0;\n}\n#hxToast {\n  padding: 0.75rem;\n  display: flex;\n}\n#hxIconWrapper {\n  align-items: center;\n  color: var(--hxIcon-color, inherit);\n  display: flex;\n  margin: 0 0.75rem 0 0.5rem;\n}\n#hxIconWrapper hx-icon {\n  font-size: 2rem;\n}\n#hxContent {\n  flex-grow: 1;\n  margin-right: 1.5rem;\n  text-align: right;\n  word-wrap: break-word;\n}\n#hxContent div {\n  font-size: 0.875rem;\n  text-align: left;\n}\n#hxCta {\n  text-transform: uppercase;\n}\n#hxCta:empty {\n  display: none;\n}\n#hxDismiss {\n  background-color: transparent;\n  border: 0;\n  color: inherit;\n  cursor: pointer;\n  display: inline-block;\n  font: inherit;\n  font-weight: 500;\n  line-height: 1;\n  margin: 0;\n  padding: 0;\n  color: var(--hxDismiss-color, #757575);\n  flex-shrink: 0;\n  font-size: 0.75rem;\n  height: 2.25rem;\n  padding: 0.75rem;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 2.25rem;\n}\n:host([type=\"info\"]) #hxIconWrapper {\n  color: var(--hxIcon-color, #3b44a9);\n}\n:host([type=\"error\"]) #hxIconWrapper {\n  color: var(--hxIcon-color, #d32f2f);\n}\n:host([type=\"success\"]) #hxIconWrapper {\n  color: var(--hxIcon-color, #4caf51);\n}\n";
    ...
    var Elements = /*#__PURE__*/Object.freeze({
        ...
        HXFormControlElement: HXFormControlElement,
