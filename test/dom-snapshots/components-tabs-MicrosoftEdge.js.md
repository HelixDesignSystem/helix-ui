# Snapshot report for `built/dom-snapshots/components-tabs-MicrosoftEdge.js`

The actual snapshot is saved in `components-tabs-MicrosoftEdge.js.snap`.

Generated by [AVA](https://ava.li).

## MicrosoftEdge on Windows 10 -- components/tabs/index.html
