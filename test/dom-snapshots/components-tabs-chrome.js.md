# Snapshot report for `built/dom-snapshots/components-tabs-chrome.js`

The actual snapshot is saved in `components-tabs-chrome.js.snap`.

Generated by [AVA](https://ava.li).

## chrome on macOS 10.13 -- components/tabs/index.html
...
## chrome -- components/tabs/index.html
