# Snapshot report for `built/dom-snapshots/components-typography-syntax-diff-chrome.js`

The actual snapshot is saved in `components-typography-syntax-diff-chrome.js.snap`.

Generated by [AVA](https://ava.li).

## chrome on macOS 10.13 -- components/typography/test/syntax-diff.html
...
## chrome -- components/typography/test/syntax-diff.html
