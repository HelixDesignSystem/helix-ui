# Snapshot report for `built/dom-snapshots/components-tabs-safari.js`

The actual snapshot is saved in `components-tabs-safari.js.snap`.

Generated by [AVA](https://ava.li).

## safari on macOS 10.13 -- components/tabs/index.html
