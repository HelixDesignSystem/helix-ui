# Snapshot report for `built/dom-snapshots/components-buttons-internet-explorer.js`

The actual snapshot is saved in `components-buttons-internet-explorer.js.snap`.

Generated by [AVA](https://ava.li).

## internet explorer on Windows 10 -- components/buttons/index.html
