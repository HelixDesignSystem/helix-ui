# Snapshot report for `built/dom-snapshots/components-typography-syntax-markdown-safari.js`

The actual snapshot is saved in `components-typography-syntax-markdown-safari.js.snap`.

Generated by [AVA](https://ava.li).

## safari on macOS 10.13 -- components/typography/test/syntax-markdown.html
