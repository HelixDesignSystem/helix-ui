# Snapshot report for `built/dom-snapshots/components-tabs-internet-explorer.js`

The actual snapshot is saved in `components-tabs-internet-explorer.js.snap`.

Generated by [AVA](https://ava.li).

## internet explorer on Windows 10 -- components/tabs/index.html
