# Snapshot report for `built/dom-snapshots/components-typography-syntax-html-firefox.js`

The actual snapshot is saved in `components-typography-syntax-html-firefox.js.snap`.

Generated by [AVA](https://ava.li).

## firefox on macOS 10.13 -- components/typography/test/syntax-html.html
...
## firefox -- components/typography/test/syntax-html.html
