# Snapshot report for `built/dom-snapshots/components-typography-syntax-bash-chrome.js`

The actual snapshot is saved in `components-typography-syntax-bash-chrome.js.snap`.

Generated by [AVA](https://ava.li).

## chrome on macOS 10.13 -- components/typography/test/syntax-bash.html
...
## chrome -- components/typography/test/syntax-bash.html
