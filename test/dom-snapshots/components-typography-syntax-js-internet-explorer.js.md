# Snapshot report for `built/dom-snapshots/components-typography-syntax-js-internet-explorer.js`

The actual snapshot is saved in `components-typography-syntax-js-internet-explorer.js.snap`.

Generated by [AVA](https://ava.li).

## internet explorer on Windows 10 -- components/typography/test/syntax-js.html
