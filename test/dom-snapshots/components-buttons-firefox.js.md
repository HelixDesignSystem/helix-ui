# Snapshot report for `built/dom-snapshots/components-buttons-firefox.js`

The actual snapshot is saved in `components-buttons-firefox.js.snap`.

Generated by [AVA](https://ava.li).

## firefox on macOS 10.13 -- components/buttons/index.html
...
## firefox -- components/buttons/index.html
