# Snapshot report for `built/dom-snapshots/components-typography-syntax-diff-firefox.js`

The actual snapshot is saved in `components-typography-syntax-diff-firefox.js.snap`.

Generated by [AVA](https://ava.li).

## firefox on macOS 10.13 -- components/typography/test/syntax-diff.html
...
## firefox -- components/typography/test/syntax-diff.html
