# Snapshot report for `built/dom-snapshots/components-typography-typefaces-safari.js`

The actual snapshot is saved in `components-typography-typefaces-safari.js.snap`.

Generated by [AVA](https://ava.li).

## safari on macOS 10.13 -- components/typography/test/typefaces.html
