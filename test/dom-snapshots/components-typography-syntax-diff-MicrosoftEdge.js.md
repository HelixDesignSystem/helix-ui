# Snapshot report for `built/dom-snapshots/components-typography-syntax-diff-MicrosoftEdge.js`

The actual snapshot is saved in `components-typography-syntax-diff-MicrosoftEdge.js.snap`.

Generated by [AVA](https://ava.li).

## MicrosoftEdge on Windows 10 -- components/typography/test/syntax-diff.html
