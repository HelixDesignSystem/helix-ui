# Snapshot report for `built/dom-snapshots/components-typography-syntax-ini-firefox.js`

The actual snapshot is saved in `components-typography-syntax-ini-firefox.js.snap`.

Generated by [AVA](https://ava.li).

## firefox on macOS 10.13 -- components/typography/test/syntax-ini.html
...
## firefox -- components/typography/test/syntax-ini.html
