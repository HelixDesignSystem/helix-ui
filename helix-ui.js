...
window.addEventListener('WebComponentsReady', function () {
    ...
    var icons = {
        ...
        'plus-or-minus': __webpack_require__(40),
        'search': __webpack_require__(41),
        'sort': __webpack_require__(42),
        'sort-down': __webpack_require__(43),
        'sort-up': __webpack_require__(44),
        'support': __webpack_require__(45),
        'times': __webpack_require__(46),
        'times-circle': __webpack_require__(47)
    };

    template.innerHTML = '\n        <style>' + __webpack_require__(48) + '</style>\n        <slot></slot>\n    ';
...
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 16 16\"><path d=\"M15 9L1 9 1 7 15 7z\"></path></svg>"
...
window.addEventListener('WebComponentsReady', function () {
    ...
    template.innerHTML = '\n      <style>' + __webpack_require__(50) + '</style>\n      ' + __webpack_require__(51) + '\n    ';
