...
/**
 * <hx-checkbox-set> component tests
 *
 * @type HXCheckboxSetElement
 *
 */
describe('<hx-checkbox-set> component tests', () => {
    const template = '<hx-checkbox-set>';

    describe('instantiate element', () => {
        it('should be instantiated with hx-defined attribute', async () => {
            const component = /** @type {HXCheckboxSetElement} */ await fixture(template);
    ...
    describe('test <hx-checkbox-set> getters and setters', () => {
